...
async function main() {
  ...
  function updateRenderCamPosition(phase) {
    ...
    renderCamL.sk.x = -offset.x -renderCamL.pos.x * invd / (1 - renderCamL.pos.z * invd);
    renderCamL.sk.y = -offset.y -renderCamL.pos.y * invd / (1 - renderCamL.pos.z * invd);
    renderCamR.sk.x = -offset.x -renderCamR.pos.x * invd / (1 - renderCamR.pos.z * invd);
    renderCamR.sk.y = -offset.y -renderCamR.pos.y * invd / (1 - renderCamR.pos.z * invd);
